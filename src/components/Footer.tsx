...
const Footer = ({ variant = 'design1' }: FooterProps) => {
  ...
  const socialLinks = [
    ...
    { name: 'Telegram', href: 'https://t.me/fomopedia', icon: (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-700 dark:text-gray-200 text-sm">
                <a href="mailto:info@in-fomo.com" className="hover:text-primary hover:underline underline-offset-4 decoration-primary decoration-2 transition-transform transform-gpu hover:-translate-y-[1px] transition-colors font-bold" aria-label="Email"style={{ willChange: 'transform' }}>
                  info@in-fomo.com
                </a>
              </p>
                ...
                {navItems.map((item) => (
                  <li key={item.href}>
                    <Link
                      ...
                      className="text-gray-700 dark:text-gray-200 text-sm hover:text-primary hover:underline underline-offset-4 decoration-primary decoration-2 transition-transform transform-gpu hover:-translate-y-[1px] transition-colors"
                      style={{ willChange: 'transform' }}
                    >
                      {item.label}
                    </Link>
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    ...
                    href="/privacy-policy"
                    className="uppercase text-gray-700 dark:text-gray-200 text-sm hover:text-primary hover:underline underline-offset-4 decoration-primary decoration-2 transition-transform transform-gpu hover:-translate-y-[1px] transition-colors"
                    style={{ willChange: 'transform' }}
                  >
                    {t('privacy_policy')}
                  </Link>

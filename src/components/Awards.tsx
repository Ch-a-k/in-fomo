        ...
        <div className="flex flex-col md:flex-row md:items-center">
          ...
          <div className="md:w-1/3 mb-4 md:mb-0 md:pr-8">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              {/* Добавляем 5 звездочек с ссылкой на Clutch */}
              <a 
                href="https://clutch.co/profile/fomo-0#reviews" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="inline-flex items-center gap-1" 
                title={hasTranslations ? t('clutch_reviews') || "View our Clutch reviews" : "Посмотреть отзывы на Clutch"}
              >
                {[1, 2, 3, 4, 5].map((star) => (
                  <svg 
                    key={star} 

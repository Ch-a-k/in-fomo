...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: t('mobile_development_desc')
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: t('cloud_solutions'),
      description: t('cloud_solutions_desc')
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: t('ai_solutions_desc')
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      title: t('bot_development'),
      description: t('bot_development_desc')
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: t('crm_development'),
      description: t('crm_development_desc')
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: t('business_consulting_desc')
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: t('web3_blockchain'),
      description: t('web3_blockchain_desc')
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: t('telegram_mini_apps'),
      description: t('telegram_mini_apps_desc')
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: t('parsers_scrapers'),
      description: t('parsers_scrapers_desc')
    }
  ];
